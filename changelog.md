...
- 🐛 FIX El widget de Android había desaparecido (se eliminó su código nativo y "Módulo nativo no disponible"). Restaurado en Kotlin: se ve en el selector de widgets como "Agenda de hoy", muestra la fecha, el progreso y las tareas pendientes del día (con 🔄 en las repetidas), sigue el idioma del sistema (es, en, fr, pt, it) y modo oscuro, al tocar una tarea se abre esa tarea en su día, y al tocar el resto abre la app. Recibe hoy y los 7 días siguientes, así que a medianoche (y tras reiniciar el móvil o cambiar la hora) pasa solo al día nuevo sin abrir la app; si la app lleva más de una semana sin abrirse, pide abrirla en vez de enseñar tareas de otro día. La política de privacidad lo menciona de nuevo en los 4 idiomas
